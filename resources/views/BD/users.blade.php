...
@section('style')
    <link rel="stylesheet" href="{{ asset('css/users.css') }}" media="screen">
@endsection
...
<section class="u-clearfix u-section-1" id="sec-dc21">
    <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-expanded-width u-table u-table-responsive u-table-1">
            <table class="u-table-entity">
                ...
                <tr style="height: 46px;">
                    ...
                    <th class="u-border-1 u-border-palette-1-base u-table-cell">Логин</th>
                    <th class="u-border-1 u-border-palette-1-base u-table-cell">Точка работы</th>
                    <th class="u-border-1 u-border-palette-1-base u-table-cell">Уровень доступа</th>
        ...
        <a href="#sec-605b" class="u-border-none u-btn u-button-style u-dialog-link u-palette-3-dark-2 u-text-hover-black u-btn-1">Изменить</a>
        <a href="" class="u-border-none u-btn u-button-style u-palette-2-dark-1 u-text-hover-black u-btn-2">Удалить</a><span class="u-dialog-link u-icon u-text-custom-color-2 u-icon-1" data-href="#sec-0432"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 42 42" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-f894"></use></svg><svg class="u-svg-content" viewBox="0 0 42 42" x="0px" y="0px" id="svg-f894" style="enable-background:new 0 0 42 42;"><path style="fill:currentColor;" d="M37.059,16H26V4.941C26,2.224,23.718,0,21,0s-5,2.224-5,4.941V16H4.941C2.224,16,0,18.282,0,21
